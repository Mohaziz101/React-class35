...
function Products() {
  ...
  const [isProductsLoading, productsError, performFetchProducts] =
    useFetch(setProducts);

  useEffect(() => {
    performFetchCategories("https://fakestoreapi.com/products/categories");
